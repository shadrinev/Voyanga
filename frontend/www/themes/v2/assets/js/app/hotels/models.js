...
HotelsResultSet = (function() {
  ...
  function HotelsResultSet(rawHotels, searchParams) {
    ...
    this.goToDetails = __bind(this.goToDetails, this);
  ...
  HotelsResultSet.prototype.goToDetails = function(hotel) {
    console.log(hotel);
    return window.app.navigate("#hotels/info/" + this.cacheId + "/" + hotel.hotelId + "/", {
      trigger: true
    });
  };
