...
<div class="mainWrapBg" style='display: none;'>
	<div class="projectPopUp">
		    ...
		    <h3>Планировщик поездки</h3>
                    <p>Помимо поиска авиабилетов или гостиниц, мы сделали планировщик.
                       С его помощью можно быстро и легко составить свою поездку, объединив разные
                       города, даты, гостиницы и авиабилеты (а совсем скоро добавим ещё ЖД, страхование, аренду авто и экскурсии!). 
                       Составленную поездку можно сохранить и поделиться ею друзьями через ссоциальные сети. 
                       <br>Всю поездку  можно легко забронировать и оплатить в один клик!</p>
                </li>
                ...
                <li class="items" rel="<?= $theme ?>/images/about05.jpg">
                    ...
                    <p>Благодаря разработанному нами интеллектуальному алгоритму поиска 
                       мы предложим вам самую лучшую цену на авиабилеты. Мы работаем с более чем 500 
                       авиакомпаниями, тремя системами бронирования, группируем схожие рейсы, отсекаем 
                       зведомо неподходящие предложения, подбираем стыковки с удобными пересадками и показываем
                       только честную и финальную цену.
                       <br><br>Все авиабилеты мы продаем без комиссии, а деньги с вас списывает сама авиакомпания.</p>
                </li>
