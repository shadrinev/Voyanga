	...
	<div class="projectPopUp">
            ...
            <ul class="textSlideProj">
                <li class="items" rel="<?= $theme ?>/images/about01.jpg">
                    <h3>Voyanga - это сервис индивидуальных путешествий</h3>
                    <p>Voyanga любит тебя сильнее, чем твоя бабушка, и найдет для тебя самые лучшие авиабилеты и гостиницы. 
                       Мы знаем как найти лучший отель в городе, как купить самый недорогой авиабилет и спланировать всю поездку. Мы сделали, на 
                       наш взгляд, лучший сервис по самому быстрому и удобному способу организации путешествий,
                       объединив продажу ключевых услуг в области путешествий в рамках единого online-сервиса.
                       </p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about02.jpg">
		    <h3>Планировщик поездки</h3>
                    <p>Помимо обычного поиска авиабилетов или гостиниц, мы сделали планировщик.
                       С помощью него можно быстро и легко составить свою поездку, объединив единое целое разные
                       города и даты, гостиницы и авиабилеты (а совсем скоро добавим ещё ЖД, страхование, аренду авто и экскурсии!). 
                       Составленную поездку можно сохранить и поделиться ею друзьями через ссоциальные сети. 
                       <br><br>Всю поездку  можно легко забронировать и оплатить в один клик!</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about08.jpg">
                    <h3>Добрый робот Вояша</h3>
                    <p>Как только вы определились с городами и датами в планировщике поездки, мы уже заранее знаем
                    сколько будут стоить разные варианты поездки и с любовью подготовили для вас несколько готовых
                    вариантов, соответствующих разным критериям бюджета и уровням комфорта.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about06.jpg">
                    <h3>Календарь поездки</h3>
                    <p>Все элементы поезки удобным образом отображены на календаре, который наглядно покажет весь план
                       составленного путешествия, гостиницы, в которых вы забронировали номер, выбранные перелеты.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about03.jpg">
                    <h3>Скидки за комплекс</h3>
                    <p>За бронирование комплексных поездок (поездка состаящая из авиабилетов и гостиниц) мы даём скидки! 
                       Таким образом, покупая у нас всю поездку целиком, вы экономите не только свое время и нервы, 
                       но ещё и свои деньги! 
                       </p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about04.jpg">
                    <h3>Идеи путешествий</h3>
                    <p>Мы регулярно публикуем интересные идеи для путешествий, будь то романтическая поездка на 
                       выходные в Париж, или фестиваль джаза в Лондоне. Путешествия тщательно и с любовью составляются 
                       и подбираются 
                       нашими контент-менеджерами. Любую составляющую готовой поездки, будь то авиабилет или гостиница, 
                       всегда можно поменять на свой вкус. <br><br> А ещё, наш робот Вояша постоянно проверяет наличие 
                ...
                <li class="items" rel="<?= $theme ?>/images/about05.jpg">
                    ...
                    <p>Благодаря разработанному нами интеллектуальному алгоритму поиска и анализа цен на авиабилеты
                       мы предложим вам самую лучшую цену на выбранные даты и направления. Мы работаем с более чем 500 
                       авиакомпаниями, тремя системами бронирования, группируем похожие рейсы, отсекаем множество
                       зведомо неподходящих предложений, подбираем стыковки с удобными пересадками и всегда показываем
                       только честную и финальную цену.
                       <br><br>Все авиабилеты мы продаем без наценки, а деньги с вашей карточки списывает напрямую сама авиакомпания.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about07.jpg">
                    ...
                    <p>Цены на авиабилеты меняются постоянно и могут существенно зависить от дат вашей поездки. 
                       Не до конца определились с днями или хотите сэкономить на стоимости билета, выбрав соседние даты? 
                       В выдаче авиабилетов у нас есть график динамики цен, позволяющий более удобно спланировать свою 
                       поездку. 
		       <br><br>Динамика цен основана на данных, полученных посредством запросов пользователей к нашей 
                ...
                <li class="items" rel="<?= $theme ?>/images/about09.jpg">
                    ...
                    <p>В нашей базе поиска содержится порядка 200 тысяч отелей по всему миру. Мы берем информацию по 
                       отелям от десятка различных поставщиков, выбирая самые лучшие цены, собираем отзывы о гостиницах,
                ...
                <li class="items" rel="<?= $theme ?>/images/about10.jpg">
                    <h3>Безопасность платежей и обработки персональных данных</h3>
                    <p>К оплате принимаются банковские карты международных платежных систем Visa 
                       (в том числе и Electron), Mastercard и Maestro. После оплаты выписка авиабилетов и бронирование
                       гостиниц проходит автоматически за считанные секунды.
                       <br><br>Наш сайт полностью отвечает требованиям безопасности платежных систем, все данные 
                       передаются в зашифрованном виде по защищенному протоколу. Мы используем систему платежей от 
                       одного из лучших в мире процессинговых центров.
                       <br><br>Вся оплата производится прямо на нашем сайте.</p>
                </li>
            </ul>
