	...
	<div class="projectPopUp">
            ...
            <ul class="textSlideProj">
                <li class="items" rel="<?= $theme ?>/images/about01.jpg">
                    ...
                    <p>Voyanga любит тебя сильнее, чем твоя бабушка, и найдет для тебя самые лучшие авиабилеты и гостиницы! 
                       <br><br>Мы знаем как найти лучший отель в городе, как купить самый недорогой авиабилет и спланировать всю поездку. Мы сделали, на 
		    ...
		    <h3>Планировщик поездки</h3>
                    <p>Помимо поиска авиабилетов или гостиниц, мы сделали планировщик.
                       ...
                       <br><br>Составленным путешествием можно поделиться с друзьями через социальные сети, а всю поездку можно забронировать и оплатить в один клик!</p>
                </li>
                ...
                <li class="items" rel="<?= $theme ?>/images/about03.jpg">
                    ...
                    <p>За бронирование комплексных поездок (состаящих из авиабилетов и гостиниц) мы даём скидки! 
                       Таким образом, покупая у нас всю поездку целиком, вы экономите не только время и нервы, 
                ...
                <li class="items" rel="<?= $theme ?>/images/about04.jpg">
                    ...
                    <p>Мы регулярно публикуем интересные идеи для путешествий, будь то романтическая поездка на 
                       выходные в Париж, или фестиваль джаза в Лондоне. Все путешествия с любовью составляются 
                       и подбираются 
                       нашими контент-менеджерами, а каждый элемент готовой поездки всегда можно поменять на свой вкус. 
