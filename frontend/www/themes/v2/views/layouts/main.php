	...
	<div class="projectPopUp">
            ...
            <ul class="textSlideProj">
                <li class="items" rel="<?= $theme ?>/images/about01.jpg">
                    ...
                    <p>Voyanga любит тебя сильнее, чем твоя бабушка, и найдет для тебя самые лучшие авиабилеты и гостиницы. 
                      ...
                      <br>За время работы в сфере online-бронирования мы накопили большой технический опыт и наладили
                       связи со всеми системами бронирования, авиакомпаниями и отелями.
                       </p>
                </li>
		    ...
		    <h3>Планировщик поездки</h3>
                    <p>С помощью планировщика можно быстро и легко составить свою поездку, объединив разные
                       города и даты, гостиницы и авиабилеты (а совсем скоро добавим ещё ЖД, аренду авто и экскурсии!). 
                       Составленную поездку можно сохранить и поделиться ею друзьями через ссоциальные сети. Всю поездку
                       можно забронировать и оплатить в один клик!</p>
                </li>
                ...
                <li class="items" rel="<?= $theme ?>/images/about05.jpg">
                    <h3>Анализ динамики за целый месяц 5</h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about06.jpg"><h3>Анализ динамики за целый месяц 6 </h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about07.jpg"><h3>Анализ динамики за целый месяц 7</h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about08.jpg"><h3>Анализ динамики за целый месяц 8</h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about09.jpg"><h3>Анализ динамики за целый месяц 9</h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about10.jpg"><h3>Анализ динамики за целый месяц 10</h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
