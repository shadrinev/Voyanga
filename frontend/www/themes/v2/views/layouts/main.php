	...
	<div class="projectPopUp">
            ...
            <ul class="textSlideProj">
                <li class="items" rel="<?= $theme ?>/images/about01.jpg">
                    <h3>Сервис индивидуальных путешествий</h3>
		    ...
		    <h3>Планировщик поездки</h3>
                    <p>Помимо поиска авиабилетов или гостиниц, мы сделали планировщик.
                       ...
                       города, даты, гостиницы и авиабилеты (скоро добавим ещё ЖД, страхование, аренду авто и экскурсии!). 
                       Составленным путешествием можно поделиться с друзьями через ссоциальные сети. 
                ...
                <li class="items" rel="<?= $theme ?>/images/about06.jpg">
                    ...
                    <p>Все элементы поезки удобным образом отображены на календаре, который наглядно покажет весь план
                       составленного путешествия, гостиницы, в которых вы забронировали номер и выбранные перелеты.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about03.jpg">
                    <h3>Скидки за комплекс</h3>
                    <p>За бронирование комплексных поездок (состаящих из авиабилетов и гостиниц) мы даём скидки! 
                ...
                <li class="items" rel="<?= $theme ?>/images/about04.jpg">
                    ...
                    <p>Мы регулярно публикуем интересные идеи для путешествий, будь то романтическая поездка на 
                       выходные в Париж, или фестиваль джаза в Лондоне. Путешествия с любовью составляются 
                       и подбираются 
                       нашими контент-менеджерами. Каждый элемент готовой поездки всегда можно поменять на свой вкус. 
