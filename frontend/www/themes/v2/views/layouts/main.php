...
<div class="mainWrapBg" style='display: none;'>
	<div class="projectPopUp">
            ...
            <ul class="textSlideProj">
                ...
                <li class="items" rel="<?= $theme ?>/images/about06.jpg"><h3>Анализ динамики за целый месяц 2 </h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about07.jpg"><h3>Анализ динамики за целый месяц 3</h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about08.jpg"><h3>Анализ динамики за целый месяц 4</h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about09.jpg"><h3>Анализ динамики за целый месяц 3</h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
                <li class="items" rel="<?= $theme ?>/images/about10.jpg"><h3>Анализ динамики за целый месяц 4</h3>
                    <p>Можно подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Аналогично  подобрать самый дешевый билет, если вам не столь важна дата поездки.
                        Третья строчка, если вам не столь важна дата поездки.</p>
                </li>
