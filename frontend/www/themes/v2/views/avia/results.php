...
<div class="ticket-content">
  ...
  <div class="ticket-items" data-bind="visible: visible()">
    ...
    <div class="how-long">
      ...
      <div class="path" onmousemove="PopUpInfoPath(this)" onmouseout="PopUpInfoPathRemove()" data-bind="text:stopoverText(), css: {'no-wait': direct()}" rel="Пересадка в Дублине 1ч. 25м. <br> Пересадка в Москве 1ч. 10м.">
      </div>
    </div>
    <!-- END HOW LONG -->
    <div class="finish">
