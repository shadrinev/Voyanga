  ...
  <table class="panelTable AVIA">
    <tr>
      <td class="contTD">
        <div class="data">
          <div class="from">
            <input class="input-path" type="text" placeholder="Откуда" data-bind="autocomplete: {source:'city/airport_req/1', iata: departureCity}">
            <div class="date">
          ...
          <div class="to">
            <input class="input-path" type="text" placeholder="Куда" data-bind="autocomplete: {source:'city/airport_req/1', iata: arrivalCity}">
            <div class="date">
              <span class="f17">12</span>
              <br>
              <span class="month">мая</span>
