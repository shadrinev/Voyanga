...
<script type="text/html" id="avia-filters">
    <div class="filter-content">
        ...
        <div class="div-filter">
            <div class="slider-filter smallSlide" style="text-align:center; margin-bottom:14px;">
                <div>
            ...
            <h4 style="margin-top:25px">Время прилета<span class="flightDirectionName"> туда</span></h4>
