...
<html>
  ...
  <body class="whiteBody">
        ...
        <div id="payments-ok" style="display:none;">
          <h2>Все свободны, ждите билеты</h2>
            <div class="text">
                Ваш платеж успешно обработан. В течении пяти минут на указанный email мы вышлем выписанные билеты, так же статус заказа можно отслеживать в личном кабинете. Если через 15 минут вы так и не получите электронного письма с подтверждением, пожалуйста, свяжитесь с нашим отделом обслуживания клиентов по телефону +7 (499) 553-09-33, мы отправим ваши билеты ещё раз.<br>
                <a data-bind="click: close, text: data.buttonText" style="margin-top:20px" class="btnBackMain" href="#">Перейти на главную</a>
            </div>
        </div>
        <div id="payments-fail" style="display:none;">
          <h2>Все свободны, все зафейлилось</h2>
            <div class="text">
                ...
                Если это не так, пожалуйста, свяжитесь с нашим отделом обслуживания клиентов по телефону +7 (499) 553-09-33.<br>
                <a data-bind="click: close, text: data.buttonText" style="margin-top:20px" class="btnBackMain" href="#">Перейти на главную</a>
            </div>
