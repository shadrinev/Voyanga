...
               <input type="checkbox" data-bind="checkbox:{label: 'Я согласен с <a href=\'/agreement_avia\'>условиями использования</a>,<br><a href=\'/iata\'>правилами IATA</a> и правилами тарифов', checked: 0}" name="agree" id="agreeCheck">
           </label>
        </div>
