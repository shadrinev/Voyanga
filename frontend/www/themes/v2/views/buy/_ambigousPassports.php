            ...
            <tr>
                ...
                <td class="tdDocumentNumber">
                    <span class="tooltipClose"
                          rel="Для перелетов по России необходим российский или загран-паспорт (для детей — свидетельство о рождении или загранпаспорт). Для зарубежных перелетов необходим загранпаспорт.">Серия и № документа</span>
                </td>
                <td class="tdDuration">
                    <span class="tooltipClose"
