                                    ...
                                    <div class="data">
                                        <div class="from" data-bind="css: {active: checkIn()}">
                                            ...
                                            <input type="text" placeholder="Куда едем?" class="second-path"
                                                   data-bind="autocomplete: {name: 'hotel', source:'city/hotel_req/1', iata: $data.city, readable: cityReadable, readableAcc: cityReadableAcc, readableGen: cityReadableGen, readablePre: cityReadablePre}"
                                                   autocomplete="off">
