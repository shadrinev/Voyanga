<script type="text/html" id="event-index">
    <div class="center" data-bind="foreach: events">
        <div class="toursTicketsMain " data-bind="css: {active: active}, attr: {rel: image}">
            ...
            <div class="innerTours" data-bind="click: $parent.setActive">
                <div class="imgTours">
                    <img data-bind="attr: {src: thumb}">
                </div>
                <div class="textTours">
                    <a data-bind="text: title, attr:{href: eventPageUrl}">Пять дней в столице Англии</a>
                    <div class="priceEvent"><a href="#1" data-bind="attr:{href: eventPageUrl}">от <span class="price" data-bind="text: minimalPrice()">15 250</span> <span class="rur">o</span></a></div>
                </div>
            </div>
            <div class="l"></div>
