  ...
  <div class="hotel-details">
    ...
    <div class="place-buy" id="hotels-popup-header2">
      ...
      <div class="book">
        ...
        <a href="#" class="btn-cost" data-bind="click: parent.selectFromPopup, css:{selected: tours()?isActive():false}, visible: !window.toursOverviewActive"><span class="l"></span><span class="text" data-bind="text:selectText">Выбрать отель</span></a>
      </div>
    </div>
