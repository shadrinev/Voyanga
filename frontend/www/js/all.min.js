...
"-5px"):c.find(".schedule-of-prices li").find(".price").css("left","0px")}function ResizeAvia(){window.resizeAviaThrottle&&(clearTimeout(window.resizeAviaThrottle),window.resizeAviaThrottle=null);window.resizeAviaThrottle=setTimeout(ResizeAviaClb,1E3/30)}function ResizeAviaClb(){console.log("!!!! DNIWE EBANOE!!!");ResizeCenterBlock();inTheTwoLines();smallTicketHeight();CenterIMGResize();slideToursSlide();smallIMGresizeIndex();mapAllPageView();gradientResize();resizePanel();startIE()}
function ResizeFun(){ResizeAvia()}$(window).load(function(){$(window).scroll(function(c){scrollValue("avia",c);scrollValue("hotel",c);window.hotelsScrollCallback()})});function readMoreService(c){$(c).hasClass("active")?($(".hideService").animate({height:"34px"},300),$(c).text("\u041f\u043e\u0434\u0440\u043e\u0431\u043d\u0435\u0435"),$(c).removeClass("active")):($(".hideService").animate({height:"100%"},300),$(c).text("\u0421\u0432\u0435\u0440\u043d\u0443\u0442\u044c"),$(c).addClass("active"))}
...
a;i++)b=$(this).find("ul.minimize li").eq(i),!0==b.hasClass("active")&&1==i?$(this).find(".left").addClass("none"):!0==b.hasClass("active")&&i==a-1&&$(this).find(".right").addClass("none")})}
function hideRecomendedBlockTicket(){$(this).hasClass("show")?($(this).removeClass("show"),$(".recomended-content").slideDown(function(){ifHeightMinAllBody()}),$(window).load(inTheTwoLines),setTimeout(smallTicketHeight,100)):($(".recomended-content").slideUp(function(){ifHeightMinAllBody()}),$(this).addClass("show"))}
...
function CenterIMGResize(c){void 0==c&&(c=0);if(0<$(".innerBlockMain").length&&$(".innerBlockMain").is(":visible")){var a=$(window).height();800>a?(a=a-38-158,$(".slideTours").addClass("small")):(a=a-38-214,$(".slideTours").removeClass("small"));$(".innerBlockMain").css("height",a+"px");var b=$(".innerBlockMain .IMGmain").eq(c).find("img"),d=0,e=$(".slideTours .center").width();c=$("div.IMGmain").eq(c).find("img").height();1390<=e?d=(1390-e)/2:1390>e&&1290<=e?d=(1390-e)/2:1290>e&&1E3<e?d=(1390-e)/
2:1E3>=e&&(d=(1390-e)/2);b.css("left","-"+d+"px");b.css("top","-"+(c-a)/2+"px")}}function smallIMGresizeIndex(){var c=$(".imgTours");0<c.length&&c.is(":visible")&&(c.find("img"),c.each(function(){var a=$(this).find("img"),b=a.height();a.width();var c=$(this).height();$(this).width();b<c&&a.css("height",c+"px")}))}
...
b){y=q[b];M!==b&&(r[a]=y);y.indexObservable(M++);k(y.mappedNodes);s.push(y);F.push(y)}function n(a,b){if(a)for(var c=0,d=b.length;c<d;c++)b[c]&&g.utils.arrayForEach(b[c].mappedNodes,function(d){a(d,c,b[c].arrayEntry)})}b=b||[];d=d||{};var j=g.utils.domData.get(a,"setDomNodeChildrenFromArrayMapping_lastMappingResult")===f,q=g.utils.domData.get(a,"setDomNodeChildrenFromArrayMapping_lastMappingResult")||[],m=g.utils.arrayMap(q,function(a){return a.arrayEntry}),p=g.utils.compareArrays(m,b),s=[],u=0,M=
0,A=[],F=[];b=[];for(var r=[],m=[],y,B=0,R,x;R=p[B];B++)switch(x=R.moved,R.status){case "deleted":x===f&&(y=q[u],y.dependentObservable&&y.dependentObservable.dispose(),A.push.apply(A,k(y.mappedNodes)),d.beforeRemove&&(b[B]=y,F.push(y)));u++;break;case "retained":h(B,u++);break;case "added":x!==f?h(B,x):(y={arrayEntry:R.value,indexObservable:g.observable(M++)},s.push(y),F.push(y),j||(m[B]=y))}n(d.beforeMove,r);g.utils.arrayForEach(A,d.beforeRemove?g.cleanNode:g.removeNode);for(var B=0,j=g.virtualElements.firstChild(a),
v;y=F[B];B++){y.mappedNodes||g.utils.extend(y,ea(a,c,y.arrayEntry,e,y.indexObservable));for(u=0;p=y.mappedNodes[u];j=p.nextSibling,v=p,u++)p!==j&&g.virtualElements.insertAfter(a,p,v);!y.initialized&&e&&(e(y.arrayEntry,y.mappedNodes,y.indexObservable),y.initialized=!0)}n(d.beforeRemove,b);n(d.afterMove,r);n(d.afterAdd,m);g.utils.domData.set(a,"setDomNodeChildrenFromArrayMapping_lastMappingResult",s)};g.exportSymbol("utils.setDomNodeChildrenFromArrayMapping",g.utils.setDomNodeChildrenFromArrayMapping);
...
return 0};c.prototype.rt=function(){return!1};c.prototype.beforeRender=function(){};return c}();
...
a.hotelId)})});a.off("select");a.on("select",function(a){f.select(a);return f.trigger("next")});return f.trigger("setActive",{data:a,template:"hotels-info-template",parent:f})};this.hotels=!0;this.selection(null);return this.results(e)};a.prototype.findAndSelect=function(a){console.log("find THRS ",a);a.roomSet?a=this.results().findAndSelect(ko.utils.unwrapObservable(a.roomSet)):(console.log(ko.utils.unwrapObservable(a.roomSets)),a=this.results().findAndSelect(ko.utils.unwrapObservable(a.roomSets)[0]));
...
a.getLatLng()));return this._selectRoomSet(c)};a.prototype.select=function(a){return this._selectRoomSet(a.roomSet)};a.prototype._selectRoomSet=function(a){var c;c=a.parent;c.parent=this.results();this.activeHotel(c.hotelId);this.overviewTemplate="tours-overview-hotels-ticket";this.selection({roomSet:a,hotel:c});c.parent.filtersConfig=c.parent.filters.getConfig();return c.parent.pagesLoad=c.parent.showParts()};a.prototype.toBuyRequest=function(){var a,c,e,f,h;a={type:"hotel"};a.searchId=this.selection().hotel.cacheId;
...
!0,this.activeHotel()?(this.results().filters.setConfig(this.results().filtersConfig),this.results().showParts(this.results().pagesLoad)):this.results().postFilters()};a.prototype.afterRender=function(){if(this.results()&&this.activeHotel())return window.setTimeout(function(){if($(".hotels-tickets .pressButton.selected").parent().parent().parent().parent().length)return Utils.scrollTo($(".hotels-tickets .pressButton.selected").parent().parent().parent().parent())},50)};a.prototype.savings=function(){return null===
this.selection()?0:this.selection().roomSet.price-this.selection().roomSet.discountPrice};return a}(TourEntry);
...
a.overview?($(".btn-timeline-and-condition").hide(),window.toursOverviewActive=!0):window.toursOverviewActive=!1;console.log("br",b,c);a.beforeRender&&b&&(console.log("brin"),a.beforeRender());this.trigger("inner-template",a.template);return window.setTimeout(function(){console.log("TourOut",window.hrs.data()[0]);a.afterRender&&c&&(console.log("arin"),a.afterRender());h.selection(a);ko.processAllDeferredBindingUpdates();ResizeAvia();$("#loadWrapBgMin").hide();!1!==e&&Utils.scrollTo(e,!1);f&&f();return console.log("TourOut2",
window.hrs.data()[0])},100)};c.prototype.setActiveTimelineAvia=function(a){return this.setActive(a.avia.item)};c.prototype.setActiveTimelineHotels=function(a){return this.setActive(a.hotel.item)};c.prototype.nextEntry=function(){var a,b,c,e;e=this.data();b=0;for(c=e.length;b<c;b++)if(a=e[b],!a.selection()){this.setActive(a);return}return this.showOverview()};c.prototype.removeItem=function(a,b){var c;b.stopPropagation();if(!(2>this.data().length)&&(c=this.data.indexOf(a),-1!==c&&(this.data.splice(c,
1),a===this.selection())))return this.setActive(this.data()[0])};c.prototype.showOverview=function(){var a,b=this;a={onlyTimeline:!0,calendarHidden:function(){return!0},calendarValue:ko.observable({values:[]})};this.setActive({template:"tours-overview",data:this,overview:!0,panel:a});ResizeAvia();return window.setTimeout(function(){var a,c,f,h,j,m,p,g,n,q,u;console.log("after render tours all tour page");console.log(b.data());c=[];q=b.data();m=0;for(g=q.length;m<g;m++){j=q[m];if(j.isAvia()){console.log("avia",
j.data.results(),j.rawSP);f=[];u=j.rawSP.destinations;p=0;for(n=u.length;p<n;p++)h=u[p],a={type:"flight",description:h.departure+" || "+h.arrival,cityFrom:h.departure_iata,cityTo:h.arrival_iata},a.dayStart=moment(h.date)._d,a.dayEnd=moment(h.date)._d,f.push(a);j.selection()&&(console.log("select:",j.selection()),a=j.selection(),f[0].dayEnd=a.arrivalDate(),a.roundTrip&&(f[1].dayEnd=a.rtArrivalDate()),console.log("city:",a.arrivalCity(),"date:",a.arrivalDate()));h=0;for(p=f.length;h<p;h++)a=f[h],c.push(a)}j.isHotel()&&
(console.log("hotel",j.data.results(),j.rawSP),f=moment(j.rawSP.checkIn).add("h",8),a=moment(j.rawSP.checkIn).add("d",j.rawSP.duration),f={dayStart:f._d,dayEnd:a._d,type:"hotel",description:"",city:j.rawSP.city},j.selection()&&(console.log("select:",j.selection()),f.description=j.selection().hotel.hotelName),c.push(f))}c.sort(function(a,b){return a.dayStart>b.dayStart?1:a.dayStart<b.dayStart?-1:0});console.log(c);VoyangaCalendarTimeline.calendarEvents=c;VoyangaCalendarTimeline.jObj="#voyanga-calendar-timeline";
return VoyangaCalendarTimeline.init()},1E3)};c.prototype.buy=function(){var a;a=$.Deferred();a.done(function(a){var c,e,f,h;c=[];h=a.data();e=0;for(f=h.length;e<f;e++)a=h[e],a.selection()&&(c.push({module:"Tours"}),c.push(a.toBuyRequest()));return Utils.toBuySubmit(c)});return this.checkTicket(this.data(),a)};c.prototype.findAndSelect=function(a){var b,c,e,f,h;console.log("findAndSelect");e=!0;c=f=0;for(h=a.length;f<h;c=++f)b=a[c],this.data()[c].findAndSelect(b.selection())||(e=!1);return e};c.prototype.findAndSelectItems=
function(a){var b,c,e,f,h,j;console.log("findAndSelectItems",a);f=!0;this.data.sort(function(a,b){var c,d,e,f;c=dateUtils.formatDayMonthYear(a.timelineStartDate());d=dateUtils.formatDayMonthYear(b.timelineStartDate());return c===d&&a.isAvia()!==b.isAvia()?null!=(e=a.timelineEndDate()>b.timelineEndDate())?e:NaN:null!=(f=a.timelineStartDate()>b.timelineStartDate())?f:NaN});h=this.data();c=0;for(e=h.length;c<e;c++)b=h[c],console.log("ts entry",b.timelineStart());console.log("allTs",this.data());c=h=
0;for(j=a.length;h<j;c=++h)b=a[c],console.log("findAndSelectItems entry",b," in ",c,this.data()[c]),this.data()[c].isAvia()?(e=this.data()[c].findAndSelect(this.data()[c].results().cheapest()),e||(f=!1,console.log("false res1:",e,this.data()[c],this.data()[c].results().cheapest()))):(e=this.data()[c].findAndSelectSame(b),e||(f=!1,console.log("false res2:",e,this.data()[c],b)));return f};return c}();
