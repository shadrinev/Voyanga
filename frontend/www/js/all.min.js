...
a.hotelId)})});a.off("select");a.on("select",function(a){f.select(a);return f.trigger("next")});return f.trigger("setActive",{data:a,template:"hotels-info-template",parent:f})};this.hotels=!0;this.selection(null);this.noresults=e.noresults;this.data.noresults=this.noresults;return this.results(e)};a.prototype.findAndSelect=function(a){console.log("find THRS ",a);a.roomSet?a=this.results().findAndSelect(ko.utils.unwrapObservable(a.roomSet)):(console.log(ko.utils.unwrapObservable(a.roomSets)),a=this.results().findAndSelect(ko.utils.unwrapObservable(a.roomSets)[0]));
...
a.overview?($(".btn-timeline-and-condition").hide(),window.toursOverviewActive=!0):window.toursOverviewActive=!1;console.log("br",b,c);a.beforeRender&&b&&(console.log("brin"),a.beforeRender());this.trigger("inner-template",a.template);return window.setTimeout(function(){console.log("TourOut",window.hrs.data()[0]);a.afterRender&&c&&(console.log("arin"),a.afterRender());console.error(a);h.selection(a);ko.processAllDeferredBindingUpdates();ResizeAvia();$("#loadWrapBgMin").hide();!1!==e&&Utils.scrollTo(e,
!1);f&&f();return console.log("TourOut2",window.hrs.data()[0])},100)};c.prototype.setActiveTimelineAvia=function(a){return this.setActive(a.avia.item)};c.prototype.setActiveTimelineHotels=function(a){return this.setActive(a.hotel.item)};c.prototype.nextEntry=function(){var a,b,c,e;e=this.data();b=0;for(c=e.length;b<c;b++)if(a=e[b],!a.selection()){this.setActive(a);return}return this.showOverview()};c.prototype.removeItem=function(a,b){var c;b.stopPropagation();if(!(2>this.data().length)&&(c=this.data.indexOf(a),
-1!==c&&(this.data.splice(c,1),a===this.selection())))return this.setActive(this.data()[0])};c.prototype.showOverview=function(){var a,b=this;a={onlyTimeline:!0,calendarHidden:function(){return!0},calendarValue:ko.observable({values:[]})};this.setActive({template:"tours-overview",data:this,overview:!0,panel:a});ResizeAvia();return window.setTimeout(function(){var a,c,f,h,j,m,p,g,n,q,u;console.log("after render tours all tour page");console.log(b.data());c=[];q=b.data();m=0;for(g=q.length;m<g;m++){j=
q[m];if(j.isAvia()){console.log("avia",j.data.results(),j.rawSP);f=[];u=j.rawSP.destinations;p=0;for(n=u.length;p<n;p++)h=u[p],a={type:"flight",description:h.departure+" || "+h.arrival,cityFrom:h.departure_iata,cityTo:h.arrival_iata},a.dayStart=moment(h.date)._d,a.dayEnd=moment(h.date)._d,f.push(a);j.selection()&&(console.log("select:",j.selection()),a=j.selection(),f[0].dayEnd=a.arrivalDate(),a.roundTrip&&(f[1].dayEnd=a.rtArrivalDate()),console.log("city:",a.arrivalCity(),"date:",a.arrivalDate()));
h=0;for(p=f.length;h<p;h++)a=f[h],c.push(a)}j.isHotel()&&(console.log("hotel",j.data.results(),j.rawSP),f=moment(j.rawSP.checkIn).add("h",8),a=moment(j.rawSP.checkIn).add("d",j.rawSP.duration),f={dayStart:f._d,dayEnd:a._d,type:"hotel",description:"",city:j.rawSP.city},j.selection()&&(console.log("select:",j.selection()),f.description=j.selection().hotel.hotelName),c.push(f))}c.sort(function(a,b){return a.dayStart>b.dayStart?1:a.dayStart<b.dayStart?-1:0});console.log(c);VoyangaCalendarTimeline.calendarEvents=
c;VoyangaCalendarTimeline.jObj="#voyanga-calendar-timeline";return VoyangaCalendarTimeline.init()},1E3)};c.prototype.buy=function(){var a;a=$.Deferred();a.done(function(a){var c,e,f,h;c=[];h=a.data();e=0;for(f=h.length;e<f;e++)a=h[e],a.selection()&&(c.push({module:"Tours"}),c.push(a.toBuyRequest()));return Utils.toBuySubmit(c)});return this.checkTicket(this.data(),a)};c.prototype.findAndSelect=function(a){var b,c,e,f,h;console.log("findAndSelect");e=!0;c=f=0;for(h=a.length;f<h;c=++f)b=a[c],this.data()[c].findAndSelect(b.selection())||
(e=!1);return e};c.prototype.findAndSelectItems=function(a){var b,c,e,f,h,j;console.log("findAndSelectItems",a);f=!0;this.data.sort(function(a,b){var c,d,e,f;c=dateUtils.formatDayMonthYear(a.timelineStartDate());d=dateUtils.formatDayMonthYear(b.timelineStartDate());return c===d&&a.isAvia()!==b.isAvia()?null!=(e=a.timelineEndDate()>b.timelineEndDate())?e:NaN:null!=(f=a.timelineStartDate()>b.timelineStartDate())?f:NaN});h=this.data();c=0;for(e=h.length;c<e;c++)b=h[c],console.log("ts entry",b.timelineStart());
console.log("allTs",this.data());c=h=0;for(j=a.length;h<j;c=++h)b=a[c],console.log("findAndSelectItems entry",b," in ",c,this.data()[c]),this.data()[c].isAvia()?(e=this.data()[c].findAndSelect(this.data()[c].results().cheapest()),e||(f=!1,console.log("false res1:",e,this.data()[c],this.data()[c].results().cheapest()))):(e=this.data()[c].findAndSelectSame(b),e||(f=!1,console.log("false res2:",e,this.data()[c],b)));return f};return c}();
