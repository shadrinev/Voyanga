...
__bind(this.updateLimitsBackVoyage,this);this.updateLimitsVoyage=__bind(this.updateLimitsVoyage,this);this.updateLimitsResult=__bind(this.updateLimitsResult,this);this.template="avia-filters";this.rt=this.results.roundTrip;this.voyageFilters=["departure","shortStopover","irrelevantlyLong","onlyDirect"];this.rtVoyageFilters=["rtDeparture","shortStopover","irrelevantlyLong","onlyDirect"];this.resultFilters=["departureAirport","arrivalAirport","airline","serviceClass"];this.departure=new PriceFilter("departureTimeNumeric");
this.rt&&(this.rtDeparture=new TimeFilter("departureTimeNumeric"));a=this.rt?["departureAirport","rtArrivalAirport"]:["departureAirport"];this.departureAirport=new ListFilter(a,this.results.departureCity,"\u0412\u0441\u0435 \u0430\u044d\u0440\u043e\u043f\u043e\u0440\u0442\u044b");a=this.rt?["arrivalAirport","rtDepartureAirport"]:["arrivalAirport"];this.arrivalAirport=new ListFilter(a,this.results.arrivalCity,"\u0412\u0441\u0435 \u0430\u044d\u0440\u043e\u043f\u043e\u0440\u0442\u044b");this.airline=
