...
"-5px"):c.find(".schedule-of-prices li").find(".price").css("left","0px")}function ResizeAvia(){window.resizeAviaThrottle&&(clearTimeout(window.resizeAviaThrottle),window.resizeAviaThrottle=null);window.resizeAviaThrottle=setTimeout(ResizeAviaClb,1E3/30)}function ResizeAviaClb(){ResizeCenterBlock();inTheTwoLines();smallTicketHeight();CenterIMGResize();slideToursSlide();smallIMGresizeIndex();mapAllPageView();gradientResize();resizePanel();startIE()}function ResizeFun(){ResizeAvia()}
