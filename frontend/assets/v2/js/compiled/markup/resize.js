...
var ResizeAvia, ResizeCenter, ResizeFun, jsPaneScrollHeight, resizePanel, scrollValue, var_iphone, var_paddingLeft, var_paddingLeftTelefonMAX, var_paddingLeftTelefonMID, var_paddingLeftTelefonMIN, var_paddingRightSlideMAX, var_paddingRightSlideMID, var_paddingRightSlideMIN, var_valueMAX, var_valueMIN, var_widthFilterMAX, var_widthFilterMID, var_widthFilterMIN, var_widthLeftBlockMAX, var_widthLeftBlockMID, var_widthLeftBlockMIN, var_widthMAX, var_widthMID, var_widthMIN, var_widthMainBlockMAX, var_widthMainBlockMIN, var_widthMiddleBlockMAX, var_widthMiddleBlockMID, var_widthMiddleBlockMIN, var_widthMiddleBlockOneMAX;
...
ResizeCenter = function() {
  var block, marginLeftContent, marginLeftLeftBlock, marginLeftMainBlock, marginRightContent, marginRightFilterBlock, marginRightMainBlock, mathWidthRicket, paddingLeftInfo, paddingLeftLogo, paddingLeftTel, paddingRightSlide, var_aboutBlock, var_allTripInfo, var_calendarGridVoyanga, var_calendarGridVoyangaIsset, var_content, var_descrIsset, var_descrItems, var_filterBlock, var_filterBlockIsset, var_hotelItems, var_leftBlock, var_leftBlockIsset, var_logoBlock, var_mainBlock, var_mainBlockIsset, var_margin, var_slideBlock, var_telefonBlock, var_ticketsItems, var_widthStreet, widthAllTripInfo, widthBlock, widthContent, widthFilterBlock, widthLeftBlock, widthMainBlock;
  block = $('.center-block');
  if (!block.length) {
    return;
  }
  ...
  if (var_descrIsset) {
    $('#descr').find('.left').find(".descr-text .text").dotdotdot({
      watch: 'window'
    });
  ...
  if ($('body').width() < 1000) {
    return $('body').addClass('scrollYes');
  } else {
    return $('body').removeClass('scrollYes');
  }
};
