...
var AviaResult, AviaResultSet, AviaSearchParams, FlightPart, MINUTE_PRICE_STEP, STOPOVER_MINUTE_PRICE, Voyage,
...
Voyage = (function() {
  ...
  function Voyage(flight, airline) {
    var hours, index, minute_price, part, stopoverInMinutes, _i, _j, _len, _len1, _ref, _ref1;
    ...
    if (!this.direct) {
      ...
      for (index = _j = 0, _len1 = _ref1.length; _j < _len1; index = ++_j) {
        ...
        this.stopoverPrice += (index + 1) * (part.stopoverLength / 60) * minute_price;
        if (part.stopoverLength > this.maxStopoverLength) {
          this.maxStopoverLength = part.stopoverLength;
        }
      }
      stopoverInMinutes = this.stopoverLength / 60;
      console.log("LENGTH", this.stopoverLength);
      console.log("IJ ", (this.stopoverLength - 1) * MINUTE_PRICE_STEP);
      console.log("SUMMA", (this.stopoverLength - 1) * MINUTE_PRICE_STEP * this.stopoverLength / 2);
      this.stopoverPrice += (stopoverInMinutes - 1) * MINUTE_PRICE_STEP * stopoverInMinutes / 2;
    }
