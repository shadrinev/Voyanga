...
var AviaResult, AviaResultSet, AviaSearchParams, FIRST_TWO_HOURS_PRICE, FlightPart, REST_HOURS_PRICE, STOPOVER_MINUTE_PRICE, Voyage,
  ...
  function Voyage(flight, airline) {
    ...
    if (!this.direct) {
      ...
      for (index = _j = 0, _len1 = _ref1.length; _j < _len1; index = ++_j) {
        ...
        this.stopoverPrice += (index + 1) * (part.stopoverLength / 60) * STOPOVER_MINUTE_PRICE;
        if (part.stopoverLength > this.maxStopoverLength) {
          this.maxStopoverLength = part.stopoverLength;
        }
      }
      stopoverInHours = this.stopoverLength / (60 * 60);
