...
(function( $ ) {
  ...
  function isArray( value ){
	...
	$.jslider = function( node, settings ){
        console.log('jslider wonna init');
	  var jNode = $(node);
