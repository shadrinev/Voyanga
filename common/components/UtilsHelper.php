...
class UtilsHelper
{
    ...
    public static function ruSoundex($str)
    {
        ...
        // реализоваза проверка предполагаемого ударения
        ...
        // кстати, надо добавить выкусывание гласных из концов слов, заканчивающихся за согласный-гласный-звонкий согласный (-ром, -лем, итд) гласная очень часто сглатывается
        ...
        $literal['С'] = array('status' => 'согласный', 'sound' => 'с'); // а вот С не хочет редуцироваться, за первый взгляд...
        ...
        // разделяем за слова, определяем кол-во слогов, заменяем ударный/безударный гласный (единственный или предполагая второй в двух-трёхсложном слове, предпредпоследний - в остальных)
    ...
    */
    ...
    public static function peopleReadable($amount)
    {
        switch ($amount)
        {
            case 0:
