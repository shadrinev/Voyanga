...
class YiiMailMessage extends CComponent
{
    ...
    public function setBody($body = '', $contentType = null, $charset = null)
    {
        if ($this->view !== null)
        {
            ...
            $viewPath = Yii::getPathOfAlias(Yii::app()->mail->viewPath) . DIRECTORY_SEPARATOR. 'layout.php';
            $body = $controller->renderInternal($viewPath, array('content'=>$body, 'subject'=>$this->getSubject()), true);
        }
