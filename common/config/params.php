...
return CMap::mergeArray(array(
    ...
    'hotel_expirationTime' => 300, //seconds before show notification message for hotel page
    'flight_expirationTime' => 300, //seconds before show notification message for flight page
