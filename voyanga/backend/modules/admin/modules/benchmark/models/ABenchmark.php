...
class ABenchmark extends CActiveRecord
{
    ...
    {
        $command = $this->getDbConnection()->createCommand("SELECT requestsPerSecond FROM benchmark_result WHERE benchmarkId = :benchmarkId");
    ...
    public function relations()
    {
        return array(
            ...
            'penultimateResult' => array(self::HAS_ONE, "ABenchmarkResult", "benchmarkId", "order" => "penultimateResult.id DESC", "condition" => "penultimateResult.id != (SELECT id FROM benchmark_result WHERE benchmarkId = penultimateResult.benchmarkId ORDER BY id DESC limit 1)"),
        );
    }
