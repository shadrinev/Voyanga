...
class OrderComponent extends CApplicationComponent
{
    ...
    public function booking()
    {
        ...
        $bookingModel->attributes = $this->getOrderParams();
        ...
        if($validSaving)
        {
            ...
            foreach($positions as $position){
                ...
                $className = get_class($position);
                if($className == 'HotelBooker')
                {
                    ...
                    //????
                    foreach($passports as $i => $roomPassport)
                    {
                ...
                elseif($className == 'FlightBooker')
                {
                    ...
                    foreach($passports as $passport)
                    {
                        ...
                        $flightPassport->attributes = $passport->attributes;
