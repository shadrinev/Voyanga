...
class CWidget extends CBaseController
{
	...
	public function render($view,$data=null,$return=false)
	{
		if(($viewFile=$this->getViewFile($view))!==false)
			...
			throw new CException(Yii::t('yii','{widget} cannot find the view "{view}" in directory "{viewdir}".',
				array('{widget}'=>get_class($this), '{view}'=>$view,'{viewdir}'=>$this->getViewPath(true).DIRECTORY_SEPARATOR)));
	}
}