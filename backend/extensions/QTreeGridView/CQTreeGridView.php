...
class CQTreeGridView extends BootGridView
{
    ...
    public function init()
    {
        ...
        {
            $left = $this->dataProvider->data[0]->leftAttribute;
            $right = $this->dataProvider->data[0]->rightAttribute;
            $level = $this->dataProvider->data[0]->levelAttribute;
            $stack = array();
            $currentLevel = 0;
            $previousModel = null;
            try
